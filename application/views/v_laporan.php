...
<div class="panel">
	 ...
	 <input placeholder="Cari data dari tanggal" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="tglmin" class="inputdate">
	 </div>
	 <div class="col-sm-4 inputtgl">
	 <input placeholder="Sampai tanggal" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="tglmax" class="inputdate"> 
	 </div>
	 <div class="col-sm-4 inputtgl">
